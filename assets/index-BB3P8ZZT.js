...
window.addEventListener("DOMContentLoaded",()=>{const H={strings:["Welcome to My Fluid WebGL Demo!","Check out the cool typing effect.","Built with Vite + npm + ❤️"," Feel free to move the cursor","or move your finger on your touch screen.","For as long as you want 😉"],typeSpeed:60,backSpeed:30,loop:!0,smartBackspace:!0,showCursor:!0,cursorChar:"|"};new Typed("#typed-output",H)})});export default pt();
