...
`),Pe=F(o.FRAGMENT_SHADER,`
    precision mediump float;
    uniform vec4 color;
    void main () {
        gl_FragColor = color;
    }
`),Me=F(o.FRAGMENT_SHADER,_.TRANSPARENT?`
    precision highp float;
...
`),ve=F(o.FRAGMENT_SHADER,`
    ...
    }`,P.supportLinearFiltering?null:["MANUAL_FILTERING"]),$e=F(o.FRAGMENT_SHADER,`
    precision mediump float;
    precision mediump sampler2D;
    varying highp vec2 vUv;
...
`),O=(o.bindBuffer(o.ARRAY_BUFFER,o.createBuffer()),o.bufferData(o.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),o.STATIC_DRAW),o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,o.createBuffer()),o.bufferData(o.ELEMENT_ARRAY_BUFFER,new Uint16Array([0,1,2,0,2,3]),o.STATIC_DRAW),o.vertexAttribPointer(0,2,o.FLOAT,!1,0,0),o.enableVertexAttribArray(0),i=>{o.bindFramebuffer(o.FRAMEBUFFER,i),o.drawElements(o.TRIANGLES,6,o.UNSIGNED_SHORT,0)});let E,x,Ne,we,Z,l,ue,Ue;const Fe=e(),oe=new B(Qe,Le),ce=new B(I,Ee),de=new B(I,qe),Se=new B(I,Pe),ge=new B(I,Me),Ae=new B(I,d),be=new B(I,Ze),Re=new B(I,pe),ze=new B(I,ye),Be=new B(I,Te),$=new B(I,He),M=new B(I,ve),re=new B(I,$e),fe=new B(I,G),ae=new B(I,X),W=new B(I,Q),he=new B(I,q),K=new Je(I,_e);function D(){const i=We(_.SIM_RESOLUTION),s=We(_.DYE_RESOLUTION),a=P.halfFloatTexType,f=P.formatRGBA,p=P.formatRG,S=P.formatR,y=P.supportLinearFiltering?o.LINEAR:o.NEAREST;E?E=Ye(E,s.width,s.height,f.internalFormat,f.format,a,y):E=Oe(s.width,s.height,f.internalFormat,f.format,a,y),x?x=Ye(x,i.width,i.height,p.internalFormat,p.format,a,y):x=Oe(i.width,i.height,p.internalFormat,p.format,a,y),Ne=V(i.width,i.height,S.internalFormat,S.format,a,o.NEAREST),we=V(i.width,i.height,S.internalFormat,S.format,a,o.NEAREST),Z=Oe(i.width,i.height,S.internalFormat,S.format,a,o.NEAREST),Ge(),Xe()}function Ge(){const i=We(_.BLOOM_RESOLUTION),s=P.halfFloatTexType,a=P.formatRGBA,f=P.supportLinearFiltering?o.LINEAR:o.NEAREST;l=V(i.width,i.height,a.internalFormat,a.format,s,f),z.length=0;for(let p=0;p<_.BLOOM_ITERATIONS;p++){const S=i.width>>p+1,y=i.height>>p+1;if(S<2||y<2)break;const N=V(S,y,a.internalFormat,a.format,s,f);z.push(N)}}function Xe(){const i=We(_.SUNRAYS_RESOLUTION),s=P.halfFloatTexType,a=P.formatR,f=P.supportLinearFiltering?o.LINEAR:o.NEAREST;ue=V(i.width,i.height,a.internalFormat,a.format,s,f),Ue=V(i.width,i.height,a.internalFormat,a.format,s,f)}function V(i,s,a,f,p,S){o.activeTexture(o.TEXTURE0);const y=o.createTexture();o.bindTexture(o.TEXTURE_2D,y),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,S),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,S),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texImage2D(o.TEXTURE_2D,0,a,i,s,0,f,p,null);const N=o.createFramebuffer();o.bindFramebuffer(o.FRAMEBUFFER,N),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,y,0),o.viewport(0,0,i,s),o.clear(o.COLOR_BUFFER_BIT);const L=1/i,se=1/s;return{texture:y,fbo:N,width:i,height:s,texelSizeX:L,texelSizeY:se,attach(Ce){return o.activeTexture(o.TEXTURE0+Ce),o.bindTexture(o.TEXTURE_2D,y),Ce}}}function Oe(i,s,a,f,p,S){let y=V(i,s,a,f,p,S),N=V(i,s,a,f,p,S);return{width:i,height:s,texelSizeX:y.texelSizeX,texelSizeY:y.texelSizeY,get read(){return y},set read(L){y=L},get write(){return N},set write(L){N=L},swap(){const L=y;y=N,N=L}}}function Ve(i,s,a,f,p,S,y){const N=V(s,a,f,p,S,y);return ce.bind(),o.uniform1i(ce.uniforms.uTexture,i.attach(0)),O(N.fbo),N}function Ye(i,s,a,f,p,S,y){return i.width===s&&i.height===a||(i.read=Ve(i.read,s,a,f,p,S,y),i.write=V(s,a,f,p,S,y),i.width=s,i.height=a,i.texelSizeX=1/s,i.texelSizeY=1/a),i}function e(i){const s=o.createTexture();o.bindTexture(o.TEXTURE_2D,s),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.REPEAT),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.REPEAT),o.texImage2D(o.TEXTURE_2D,0,o.RGB,1,1,0,o.RGB,o.UNSIGNED_BYTE,new Uint8Array([255,255,255]));const a={texture:s,width:1,height:1,attach(p){return o.activeTexture(o.TEXTURE0+p),o.bindTexture(o.TEXTURE_2D,s),p}},f=new Image;return f.onload=()=>{a.width=f.width,a.height=f.height,o.bindTexture(o.TEXTURE_2D,s),o.texImage2D(o.TEXTURE_2D,0,o.RGB,o.RGB,o.UNSIGNED_BYTE,f)},a}function t(){const i=[];_.SHADING&&i.push("SHADING"),_.BLOOM&&i.push("BLOOM"),_.SUNRAYS&&i.push("SUNRAYS"),K.setKeywords(i)}t(),D(),_.IMMEDIATE&&je(_.SPLAT_COUNT);function n(){_.AUTO&&_.INTERVAL&&!_.PAUSED&&k.push(_.SPLAT_COUNT),setTimeout(n,_.INTERVAL)}setTimeout(n,_.INTERVAL);let r=Date.now(),u=0;c();function c(){const i=h();g()&&D(),b(i),v(),_.PAUSED||A(i),w(),requestAnimationFrame(c)}function h(){const i=Date.now();let s=(i-r)/1e3;return s=Math.min(s,.016666),r=i,s}function g(){const i=ne(R.clientWidth),s=ne(R.clientHeight);return R.width!==i||R.height!==s?(R.width=i,R.height=s,!0):!1}function b(i){_.COLORFUL&&(u+=i*_.COLOR_UPDATE_SPEED,u>=1&&(u=dt(u,0,1),T.forEach(s=>{s.color=tt()})))}function v(){k.length>0&&je(k.pop()),T.forEach(i=>{i.moved&&(i.moved=!1,et(i))})}function A(i){o.disable(o.BLEND),o.viewport(0,0,x.width,x.height),fe.bind(),o.uniform2f(fe.uniforms.texelSize,x.texelSizeX,x.texelSizeY),o.uniform1i(fe.uniforms.uVelocity,x.read.attach(0)),O(we.fbo),ae.bind(),o.uniform2f(ae.uniforms.texelSize,x.texelSizeX,x.texelSizeY),o.uniform1i(ae.uniforms.uVelocity,x.read.attach(0)),o.uniform1i(ae.uniforms.uCurl,we.attach(1)),o.uniform1f(ae.uniforms.curl,_.CURL),o.uniform1f(ae.uniforms.dt,i),O(x.write.fbo),x.swap(),re.bind(),o.uniform2f(re.uniforms.texelSize,x.texelSizeX,x.texelSizeY),o.uniform1i(re.uniforms.uVelocity,x.read.attach(0)),O(Ne.fbo),de.bind(),o.uniform1i(de.uniforms.uTexture,Z.read.attach(0)),o.uniform1f(de.uniforms.value,_.PRESSURE),O(Z.write.fbo),Z.swap(),W.bind(),o.uniform2f(W.uniforms.texelSize,x.texelSizeX,x.texelSizeY),o.uniform1i(W.uniforms.uDivergence,Ne.attach(0));for(let a=0;a<_.PRESSURE_ITERATIONS;a++)o.uniform1i(W.uniforms.uPressure,Z.read.attach(1)),O(Z.write.fbo),Z.swap();he.bind(),o.uniform2f(he.uniforms.texelSize,x.texelSizeX,x.texelSizeY),o.uniform1i(he.uniforms.uPressure,Z.read.attach(0)),o.uniform1i(he.uniforms.uVelocity,x.read.attach(1)),O(x.write.fbo),x.swap(),M.bind(),o.uniform2f(M.uniforms.texelSize,x.texelSizeX,x.texelSizeY),P.supportLinearFiltering||o.uniform2f(M.uniforms.dyeTexelSize,x.texelSizeX,x.texelSizeY);const s=x.read.attach(0);o.uniform1i(M.uniforms.uVelocity,s),o.uniform1i(M.uniforms.uSource,s),o.uniform1f(M.uniforms.dt,i),o.uniform1f(M.uniforms.dissipation,_.VELOCITY_DISSIPATION),O(x.write.fbo),x.swap(),o.viewport(0,0,E.width,E.height),P.supportLinearFiltering||o.uniform2f(M.uniforms.dyeTexelSize,E.texelSizeX,E.texelSizeY),o.uniform1i(M.uniforms.uVelocity,x.read.attach(0)),o.uniform1i(M.uniforms.uSource,E.read.attach(1)),o.uniform1f(M.uniforms.dissipation,_.DENSITY_DISSIPATION),O(E.write.fbo),E.swap()}function w(i){_.BLOOM&&U(E.read,l),_.SUNRAYS&&(j(E.read,E.write,ue),te(ue,Ue,1)),o.blendFunc(o.ONE,o.ONE_MINUS_SRC_ALPHA),o.enable(o.BLEND);const s=o.drawingBufferWidth,a=o.drawingBufferHeight;o.viewport(0,0,s,a);const f=null;_.TRANSPARENT||m(f,ct(_.BACK_COLOR)),_.TRANSPARENT&&C(f),ee(f,s,a)}function m(i,s){Se.bind(),o.uniform4f(Se.uniforms.color,s.r,s.g,s.b,1),O(i)}function C(i){ge.bind(),o.uniform1f(ge.uniforms.aspectRatio,R.width/R.height),O(i)}function ee(i,s,a){if(K.bind(),_.SHADING&&o.uniform2f(K.uniforms.texelSize,1/s,1/a),o.uniform1i(K.uniforms.uTexture,E.read.attach(0)),_.BLOOM){o.uniform1i(K.uniforms.uBloom,l.attach(1)),o.uniform1i(K.uniforms.uDithering,Fe.attach(2));const f=ft(Fe,s,a);o.uniform2f(K.uniforms.ditherScale,f.x,f.y)}_.SUNRAYS&&o.uniform1i(K.uniforms.uSunrays,ue.attach(3)),O(i)}function U(i,s){if(z.length<2)return;let a=s;o.disable(o.BLEND),Ae.bind();const f=_.BLOOM_THRESHOLD*_.BLOOM_SOFT_KNEE+1e-4,p=_.BLOOM_THRESHOLD-f,S=f*2,y=.25/f;o.uniform3f(Ae.uniforms.curve,p,S,y),o.uniform1f(Ae.uniforms.threshold,_.BLOOM_THRESHOLD),o.uniform1i(Ae.uniforms.uTexture,i.attach(0)),o.viewport(0,0,a.width,a.height),O(a.fbo),be.bind();for(let N=0;N<z.length;N++){const L=z[N];o.uniform2f(be.uniforms.texelSize,a.texelSizeX,a.texelSizeY),o.uniform1i(be.uniforms.uTexture,a.attach(0)),o.viewport(0,0,L.width,L.height),O(L.fbo),a=L}o.blendFunc(o.ONE,o.ONE),o.enable(o.BLEND);for(let N=z.length-2;N>=0;N--){const L=z[N];o.uniform2f(be.uniforms.texelSize,a.texelSizeX,a.texelSizeY),o.uniform1i(be.uniforms.uTexture,a.attach(0)),o.viewport(0,0,L.width,L.height),O(L.fbo),a=L}o.disable(o.BLEND),Re.bind(),o.uniform2f(Re.uniforms.texelSize,a.texelSizeX,a.texelSizeY),o.uniform1i(Re.uniforms.uTexture,a.attach(0)),o.uniform1f(Re.uniforms.intensity,_.BLOOM_INTENSITY),o.viewport(0,0,s.width,s.height),O(s.fbo)}function j(i,s,a){o.disable(o.BLEND),ze.bind(),o.uniform1i(ze.uniforms.uTexture,i.attach(0)),o.viewport(0,0,s.width,s.height),O(s.fbo),Be.bind(),o.uniform1f(Be.uniforms.weight,_.SUNRAYS_WEIGHT),o.uniform1i(Be.uniforms.uTexture,s.attach(0)),o.viewport(0,0,a.width,a.height),O(a.fbo)}function te(i,s,a){oe.bind();for(let f=0;f<a;f++)o.uniform2f(oe.uniforms.texelSize,i.texelSizeX,0),o.uniform1i(oe.uniforms.uTexture,i.attach(0)),O(s.fbo),o.uniform2f(oe.uniforms.texelSize,0,i.texelSizeY),o.uniform1i(oe.uniforms.uTexture,s.attach(0)),O(i.fbo)}function et(i){const s=i.deltaX*_.SPLAT_FORCE,a=i.deltaY*_.SPLAT_FORCE;me(i.texcoordX,i.texcoordY,s,a,i.color)}function je(i){for(let s=0;s<i;s++){const a=tt();a.r*=10,a.g*=10,a.b*=10;const f=Math.random(),p=Math.random(),S=1e3*(Math.random()-.5),y=1e3*(Math.random()-.5);me(f,p,S,y,a)}}function me(i,s,a,f,p){o.viewport(0,0,x.width,x.height),$.bind(),o.uniform1i($.uniforms.uTarget,x.read.attach(0)),o.uniform1f($.uniforms.aspectRatio,R.width/R.height),o.uniform2f($.uniforms.point,i,s),o.uniform3f($.uniforms.color,a,f,0),o.uniform1f($.uniforms.radius,xe(_.SPLAT_RADIUS/100)),O(x.write.fbo),x.swap(),o.viewport(0,0,E.width,E.height),o.uniform1i($.uniforms.uTarget,E.read.attach(0)),o.uniform3f($.uniforms.color,p.r,p.g,p.b),O(E.write.fbo),E.swap()}function xe(i){const s=R.width/R.height;return s>1&&(i*=s),i}R.addEventListener("mousedown",i=>{const s=ne(i.offsetX),a=ne(i.offsetY);let f=T.find(p=>p.id===-1);f||(f=new J),it(f,-1,s,a)}),setTimeout(()=>{R.addEventListener("mousemove",i=>{const s=ne(i.offsetX),a=ne(i.offsetY);ot(T[0],s,a)})},500),window.addEventListener("mouseup",()=>{rt(T[0])}),R.addEventListener("touchstart",i=>{i.preventDefault();const s=i.targetTouches;for(;s.length>=T.length;)T.push(new J);for(let a=0;a<s.length;a++){const f=ne(s[a].pageX),p=ne(s[a].pageY);it(T[a+1],s[a].identifier,f,p)}}),R.addEventListener("touchmove",i=>{i.preventDefault();const s=i.targetTouches;for(let a=0;a<s.length;a++){const f=ne(s[a].pageX),p=ne(s[a].pageY);ot(T[a+1],f,p)}},!1),window.addEventListener("touchend",i=>{const s=i.changedTouches;for(let a=0;a<s.length;a++){const f=T.find(p=>p.id===s[a].identifier);rt(f)}}),window.addEventListener("keydown",i=>{i.code==="KeyP"&&(_.PAUSED=!_.PAUSED),i.key===" "&&k.push(Number.parseInt(Math.random()*20)+5)});function it(i,s,a,f){i.id=s,i.down=!0,i.moved=!1,i.texcoordX=a/R.width,i.texcoordY=1-f/R.height,i.prevTexcoordX=i.texcoordX,i.prevTexcoordY=i.texcoordY,i.deltaX=0,i.deltaY=0,i.color=tt()}function ot(i,s,a){_.TRIGGER==="click"&&(i.moved=i.down),i.prevTexcoordX=i.texcoordX,i.prevTexcoordY=i.texcoordY,i.texcoordX=s/R.width,i.texcoordY=1-a/R.height,i.deltaX=st(i.texcoordX-i.prevTexcoordX),i.deltaY=lt(i.texcoordY-i.prevTexcoordY),_.TRIGGER==="hover"&&(i.moved=Math.abs(i.deltaX)>0||Math.abs(i.deltaY)>0)}function rt(i){i.down=!1}function st(i){const s=R.width/R.height;return s<1&&(i*=s),i}function lt(i){const s=R.width/R.height;return s>1&&(i/=s),i}function tt(){const i=ut(Math.random(),1,1);return i.r*=.15,i.g*=.15,i.b*=.15,i}function ut(i,s,a){let f,p,S;const y=Math.floor(i*6),N=i*6-y,L=a*(1-s),se=a*(1-N*s),Ce=a*(1-(1-N)*s);switch(y%6){case 0:f=a,p=Ce,S=L;break;case 1:f=se,p=a,S=L;break;case 2:f=L,p=a,S=Ce;break;case 3:f=L,p=se,S=a;break;case 4:f=Ce,p=L,S=a;break;case 5:f=a,p=L,S=se;break}return{r:f,g:p,b:S}}function ct(i){return{r:i.r/255,g:i.g/255,b:i.b/255}}function dt(i,s,a){const f=a-s;return f===0?s:(i-s)%f+s}function We(i){let s=o.drawingBufferWidth/o.drawingBufferHeight;s<1&&(s=1/s);const a=Math.round(i),f=Math.round(i*s);return o.drawingBufferWidth>o.drawingBufferHeight?{width:f,height:a}:{width:a,height:f}}function ft(i,s,a){return{x:s/i.width,y:a/i.height}}function ne(i){const s=window.devicePixelRatio||1;return Math.floor(i*s)}function ht(i){if(i.length===0)return 0;let s=0;for(let a=0;a<i.length;a++)s=(s<<5)-s+i.charCodeAt(a),s|=0;return s}}//! ----- background that is just pure eye candy ----- //
_t(document.querySelector("canvas"),{TRIGGER:"hover",IMMEDIATE:!0,AUTO:!1,INTERVAL:3e3,SIM_RESOLUTION:256,DYE_RESOLUTION:1024,CAPTURE_RESOLUTION:256,DENSITY_DISSIPATION:1,VELOCITY_DISSIPATION:.2,PRESSURE:.2,PRESSURE_ITERATIONS:10,CURL:30,SPLAT_RADIUS:.1,SPLAT_FORCE:6e3,SPLAT_COUNT:Number.parseInt(Math.random()*20)+5,SHADING:!0,COLORFUL:!0,COLOR_UPDATE_SPEED:10,PAUSED:!1,BACK_COLOR:{r:0,g:0,b:0},TRANSPARENT:!1,BLOOM:!1,BLOOM_ITERATIONS:8,BLOOM_RESOLUTION:256,BLOOM_INTENSITY:.8,BLOOM_THRESHOLD:.6,BLOOM_SOFT_KNEE:.7,SUNRAYS:!0,SUNRAYS_RESOLUTION:196,SUNRAYS_WEIGHT:1});//! ----- npm package that renders text in a beautiful way ----- //
window.addEventListener("DOMContentLoaded",()=>{const H={strings:["Welcome to My Fluid WebGL Demo!","Check out the cool typing effect.","Built with Vite + npm + ❤️"," Feel free to move the cursor","or move your finger on your touch screen.","For as long as you want 😉"],typeSpeed:60,backSpeed:60,loop:!0,smartBackspace:!0,showCursor:!0,cursorChar:"|"};new Typed("#typed-output",H)})});export default pt();
